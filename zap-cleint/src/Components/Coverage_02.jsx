...
const Coverage = () => {
    ...
    const onSearch = (event) => {
        ...
        const district = coveragePoints.find(point => point.name.toLowerCase().includes(inputValue.trim().toLowerCase()));

        console.log(district, district.position);

        if (district) {
            mapRef.current.flyTo(district.position, 9, { duration: 1 });
        }
